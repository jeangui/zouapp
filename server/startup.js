...
Meteor.startup(function () {
  ...
  if (Annonces.find().count() === 0) {
    ...
    var data = [
		...
		themes: 		["babysitting"],
		emplacement:		{ lat : 43.0633, lon : 5.388383 },
	...
	},
	{
		...
		echeance: 		new Date("2012,06,07,12:00:00"),
		themes: 		["babysitting"],
		emplacement:		{ lat : 43.2633, lon: 5.388383 },
		createur: 		"1898698760986098",
		start_date: 		new Date("2012,06,08,18:30:00"),
		end_date: 		new Date("2012,06,08,00:30:00"),
	},
	{
		...
		echeance: 		new Date("2012,06,07,12:00:00"),
		themes: 		["jardinerie"],
		emplacement:		{ lat : 43.3633, lon: 5.388383 },
		createur: 		"1d5f6b5a-3383-47ac-8511-8d867825d1e7",
		start_date: 		new Date("2012,06,08,18:30:00"),
		end_date: 		new Date("2012,06,08,00:30:00"),
	},
	{
		...
		echeance: 		new Date("2012,06,07,12:00:00"),
		themes: 		["jardinerie"],
		emplacement:		{ lat : 43.4633, lon: 5.388383 },
		createur: 		"1d5f6b5a-3383-47ac-8511-8d867825d1e7",
		start_date: 		new Date("2012,06,08,18:30:00"),
		end_date: 		new Date("2012,06,08,00:30:00"),
	},
	{
		...
		echeance: 		new Date("2012,06,07,12:00:00"),
		themes: 		["jardinerie"],
		emplacement:		{ lat : 43.5633, lon: 5.388383 },
		createur: 		"1898698760986098",
		start_date: 		new Date("2012,06,08,18:30:00"),
		end_date: 		new Date("2012,06,08,00:30:00"),
	}
